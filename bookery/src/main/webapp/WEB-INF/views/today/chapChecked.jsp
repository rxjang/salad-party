...
<script type="text/javascript">
	...
	var over = [ [ '쾌속 질주 중이시네요.', '내일도 이기세로 힘내요!⌒(*＾-゜)v', '010-happy' ],
			[ '미친집중력!!!', '오늘 폭풍공부하셨네요.d=(￣▽￣*)b', '034-laugh' ],
			[ '무슨소리 안들리세요?', '머리에 지식쌓이는 소리φ(゜▽゜*)♪.', '024-in love' ] ]
	var archive = [ [ '계획을 완벽하게 수행중인 당신!', '혹시 ISTJ 성향이 아니신가요?!', '028-wink' ],
			[ '열공하는 멋진 당신!', '북커리가 응원합니다.', '015-smile' ],
			[ '보람찬 하루~', '목표를 달성하셨어요!', '048-tongue' ] ]
	var under = [ [ '우리아직 갈길이 머네요...', '내일은 더 열심히 달려보자구요!', '026-sad' ],
			[ '오늘 이대로 끝낼건가요?', '내일로 미루실껀가요（；´д｀）ゞ', '039-ill' ],
	...
	$(function() {
		...
		setTimeout(
				function() {
					location.href = "${pageContext.request.contextPath}/today/chap/${v_study.study_id}"
				}, 3000);
